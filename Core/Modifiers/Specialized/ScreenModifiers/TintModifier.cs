...
{
    public class TintModifier : Modifier<ScreenEntityParams>
    {
        ...
        public override void Update(ScreenEntityParams scrparams, GameTime gametime)
        {
        ...
        public static ChainModifier<ScreenEntityParams> FadeOutIn(float minopacity, float maxopacity, float maxlife, ChainModRepeatMode repeatmode)
        {
            Modifier<ScreenEntityParams>[] modifiers = new Modifier<ScreenEntityParams>[] { FadeOut(minopacity, maxlife / 2), FadeIn(maxopacity, maxlife / 2) };
 
            return new ChainModifier<ScreenEntityParams>(modifiers, repeatmode, 0);
        }
